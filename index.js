...
const getClimates = async (nombre) => {
  // Llamo a la API
  // Transformo la respuesta a JSON
  const responseClimate = await (await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${nombre}&lang=es&appid=e12be390eed2968fe5aa62e2c6ea1681&units=metric`, {method: 'GET'})).json()
...
searchInput.addEventListener('input', async e => {
  ...
  // Si hay más de 10 países, mostrar un mensaje   
    ...
    message.innerHTML = `
    <p>Demasiados paises, se más especifico</p>
    `
